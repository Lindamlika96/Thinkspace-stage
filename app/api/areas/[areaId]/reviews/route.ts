...
const createAreaReviewSchema = z.object({
  ...
  findings: z.record(z.string(), z.any()).optional(), // Structured review findings
  improvements: z.record(z.string(), z.any()).optional(), // Improvement actions
  healthScore: z.number().min(0).max(1).optional(),
  criteriaScores: z.record(z.number(),z.any()).optional(), // Individual criteria scores
  templateId: z.string().optional(),
  template: z.record(z.string(), z.any()).optional(), // Template snapshot
});
