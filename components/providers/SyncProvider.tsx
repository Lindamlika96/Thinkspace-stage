...
export function SyncProvider({ 
  ...
  const {
    ...
    onSyncConflict: (event: RealtimeEvent) => {
      // Conflict handling is now done silently
      // Components can listen to conflicts via useSyncContext
    },
  });
  ...
  useEffect(() => {
    ...
    const handleOffline = () => {
      // Offline mode is now handled silently
      // Status is available via useSyncContext
    };
